...
Training agents to play competitively against an opponent that actively counters their 
behavior is a well-studied problem in reinforcement learning. In this work, we train 
agents for a 1v1 hockey environment inspired by air hockey, where two players compete 
on opposite sides of a rink to score goals against each other. The game requires a 
combination of offensive and defensive skills across a fully continuous action space, 
with scoring goals as the ultimate objective.
...
\url{https://github.com/JRombach/drai-rl}.