...
We implemented a framework based on \ac{YAML} configuration files to manage and persist training runs,
...
\end{equation}
where $g$ denotes the agent's goal center. All shaping components are individually configurable via the \ac{YAML} configuration file.
