...
Table~\ref{tab:win_rates}. In hindsight, we would have invested 
...
\medskip
Overall, the project provided practical insight into the challenges of reinforcement 
learning beyond what theoretical study alone can convey. Iteratively training agents, 
inspecting failure cases, and adapting the training pipeline made the complexity of 
the problem concrete. The modular infrastructure built around the training pipeline 
kept this iterative process efficient and reproducible throughout.
